...
def client_number(message):
    ...
    if tmp_message == '❌ Cancelar Registro':
        bot.reply_to(message, library_lenguage.read_header(data='CANCEL_REGISTER'))
...
def all_messages(message):
    ...
    # ===================================== MENU ================================
    if '/start' ==  MESSAGE or '◀️ Atras' ==  MESSAGE or  '/atras' == MESSAGE or '❌ Cancelar Registro' == MESSAGE: # will capture text of press buttons
    ...
    # ================================================= PLACE OR LOCATION
    elif  '/bot_mi_botella' == MESSAGE or "👋 Ayuda" == MESSAGE: # will capture text of press buttons
        message_formated = library_lenguage.read_header(data='ABOUT')
        tele_bot.send_message(  bot=bot,type_msg='message',message_id=MESSAGE_ID,message=message_formated)
